...
public class account1 {
    ...
    account1(String name,int accountnumber,double balance)
    {
        this.name = name;
    ...
    public void stringoperation(String name)
    {
        System.out.println("Your name in CAP :" +this.name.toUpperCase());
        System.out.println("Total character in string:"+this.name.length());
    }
